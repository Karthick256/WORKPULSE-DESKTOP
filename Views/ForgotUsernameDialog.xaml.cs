...
{
    public partial class ForgotUsernameDialog : Window
    {
        private readonly ForgotUsernameViewModel _viewModel;

        public ForgotUsernameDialog()
        {
            InitializeComponent();
            _viewModel = new ForgotUsernameViewModel();
        ...
        private async void Recover_Click(object sender, RoutedEventArgs e)
        {
            ...
            var success = await _viewModel.RecoverUsernameAsync();
