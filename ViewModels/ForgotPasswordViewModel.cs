...
namespace monitor_desktop.ViewModels
{
    public class ForgotPasswordViewModel : INotifyPropertyChanged
    {
        ...
        public async Task<bool> SendResetLinkAsync()
        {
            ...
            try
            {
                var request = new Models.AuthManagement.ForgotPasswordRequest { Email = Email };
                ...
                {
                    ErrorMessage = response.Message ?? "Failed to send reset email";
                    HasError = true;
                    return false;
                }
            }
